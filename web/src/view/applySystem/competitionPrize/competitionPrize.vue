    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="获奖时间" width="180">
          <template #default="scope">{{
            formatDate(scope.row.award_time)
          }}</template>
        </el-table-column>
        <el-table-column
          align="left"
        ...
        <el-table-column align="left" label="操作">
          <template #default="scope">
            ...
            <el-button
              ...
              icon="edit"
              class="table-button"
              @click="updateCompetitionPrizeFunc(scope.row)"
              >编辑</el-button
            >
            <el-button
              type="primary"
      ...
      <el-scrollbar height="500px">
        ...
        >
          ...
          <el-form-item label="比赛类型:" prop="competition_type">
            <el-input
              v-model="formData.competition_type"
              :clearable="true"
              placeholder="请输入比赛类型"
            />
          </el-form-item>
...
//       validator: (rule, value, callback) => {
//         if (
//           searchInfo.value.startAward_time &&
//           !searchInfo.value.endAward_time
//         ) {
//           callback(new Error("请填写结束日期"));
//         } else if (
//           !searchInfo.value.startAward_time &&
...
//           searchInfo.value.startAward_time &&
//           searchInfo.value.endAward_time &&
//           (searchInfo.value.startAward_time.getTime() ===
//             searchInfo.value.endAward_time.getTime() ||
//             searchInfo.value.startAward_time.getTime() >
//               searchInfo.value.endAward_time.getTime())
//         ) {
//           callback(new Error("开始日期应当早于结束日期"));
...
const getTableData = async () => {
  const table = await getCompetitionPrizeList({
    page: page.value,
