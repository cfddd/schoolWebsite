  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="获奖时间" prop="award_time">
            ...
            <el-date-picker v-model="searchInfo.startAward_time" type="datetime" placeholder="开始日期" :disabled-date="time=> searchInfo.endAward_time ? time.getTime() > searchInfo.endAward_time.getTime() : false"></el-date-picker>
            —
            <el-date-picker v-model="searchInfo.endAward_time" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startAward_time ? time.getTime() < searchInfo.startAward_time.getTime() : false"></el-date-picker>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="操作">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateCompetitionPrizeFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="比赛名称:"  prop="competition_name" >
              <el-input v-model="formData.competition_name" :clearable="true"  placeholder="请输入比赛名称" />
            </el-form-item>
            <el-form-item label="获奖时间:"  prop="award_time" >
              <el-date-picker v-model="formData.award_time" type="date" style="width:100%" placeholder="选择日期" :clearable="true"  />
            </el-form-item>
            <el-form-item label="获奖类别:"  prop="award_type" >
              <el-input v-model="formData.award_type" :clearable="true"  placeholder="请输入获奖类别" />
            </el-form-item>
            <el-form-item label="获奖等级:"  prop="award_level" >
              <el-input v-model="formData.award_level" :clearable="true"  placeholder="请输入获奖等级" />
            </el-form-item>
            <el-form-item label="比赛类型:"  prop="competition_type" >
              <el-input v-model="formData.competition_type" :clearable="true"  placeholder="请输入比赛类型" />
            </el-form-item>
  ...
  createdAt: [
    { validator: (rule, value, callback) => {
      if (searchInfo.value.startCreatedAt && !searchInfo.value.endCreatedAt) {
        ...
        award_time : [{ validator: (rule, value, callback) => {
